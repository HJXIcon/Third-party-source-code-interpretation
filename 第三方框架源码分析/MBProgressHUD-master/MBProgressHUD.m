...
/*！
 原来这里重新写了一个UIbutton的子类MBProgressHUDRoundedButton，这个子类重写了一个函数- (CGSize)intrinsicContentSize,这个函数也就是控件的内置大小。比如UILabel，UIButton等控件，他们都有自己的内置大小。我们可以重写这个函数设置控件的大小。。
 */
- (CGSize)intrinsicContentSize {
