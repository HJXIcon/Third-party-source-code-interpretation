...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        self.backgroundColor = JXProgressViewBackgroundColor;
...
- (void)drawRect:(CGRect)rect{
    ...
    switch (self.mode) {
        case JXProgressViewModePieDiagram:
        {
            CGFloat radius = MIN(rect.size.width * 0.5, rect.size.height * 0.5) - JXProgressViewItemMargin;
            
            
            CGFloat w = radius * 2 + JXProgressViewItemMargin;
            CGFloat h = w;
            ...
            [JXProgressViewBackgroundColor set];
